...
SELECT stud.name, marks.subject, marks.score 
FROM stud INNER JOIN marks 
ON stud.id = marks.student_id;

SELECT stud.name, marks.subject, marks.score
FROM stud LEFT JOIN marks
ON stud.id = marks.student_id;

SELECT stud.name, marks.subject, marks.score
FROM stud RIGHT JOIN marks
ON stud.id = marks.student_id;

SELECT stud.name, marks.subject, marks.score
FROM stud CROSS JOIN marks;